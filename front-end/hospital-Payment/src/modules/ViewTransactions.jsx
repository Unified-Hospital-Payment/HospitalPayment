        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Blockchain Transaction ID</th>
              <th scope="col" className="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Amount</th>
              <th scope="col" className="px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase">Transaction Report</th>
            </tr>
          </thead>
